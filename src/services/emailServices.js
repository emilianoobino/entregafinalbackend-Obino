        ...
        try {
            const mailOptions = {
                ...
                html: `
                    ...
                    <p>A request to reset your password or unlock your account was made for your Account, ${email}. To continue with this request, enter the code below on the verification page:</p>
